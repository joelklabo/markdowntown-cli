...
const URLS = [
  ...
  "https://klabo.world/posts/tags",
  "https://klabo.world/posts/tag/bitcoin",
  "https://klabo.world/posts/introducing-ackchyually",
  "https://klabo.world/apps",
  "https://klabo.world/apps/vicechips",
...
const client = new Client(
  { name: "klabo-audit", version: "1.1.0" },
  { capabilities: {} }
);
