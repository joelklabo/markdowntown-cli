...
func TestGeminiAdapterResolve(t *testing.T) {
	...
	writeFile(t, filepath.Join(repoRoot, "GEMINI.md"), "root")
	...
	writeFile(t, filepath.Join(subDir, "GEMINI.md"), "cwd")
	writeFile(t, filepath.Join(childDir, "GEMINI.md"), "child")
	writeFile(t, filepath.Join(ignoredDir, "GEMINI.md"), "ignored")
	writeFile(t, filepath.Join(gignoredDir, "GEMINI.md"), "gignored")

	writeFile(t, filepath.Join(repoRoot, ".gitignore"), "sub/ignored/\n")
	writeFile(t, filepath.Join(repoRoot, ".geminiignore"), "sub/gignored/\n")

	home := t.TempDir()
	t.Setenv("HOME", home)
	os.MkdirAll(filepath.Join(home, ".gemini"), 0o755)
	writeFile(t, filepath.Join(home, ".gemini", "GEMINI.md"), "global")
...
func TestGeminiAdapterCustomFilenames(t *testing.T) {
	...
	writeFile(t, filepath.Join(repoRoot, "CUSTOM.md"), "custom")
	writeFile(t, filepath.Join(repoRoot, "GEMINI.md"), "default")
